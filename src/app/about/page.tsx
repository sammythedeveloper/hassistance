...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-black dark:text-white font-mono p-10">
      <Link
        href="/"
        className="flex items-center gap-2 text-sm mb-12 opacity-50 hover:opacity-100 transition-opacity"
      >
      ...
      <article className="max-w-2xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-emerald-500 text-sm uppercase tracking-widest">
            The Tech Stack
          </h2>
          <ul className="grid grid-cols-2 gap-4 text-xs">
            <li className="border border-zinc-100 dark:border-zinc-900 p-3 rounded-lg">
