...
//       <header className="flex shrink-0 items-center justify-between gap-4 border-b border-zinc-200 bg-zinc-100/85 px-4 py-4 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-950/85 sm:px-8">
...
//             </div>
//           </form>
//           <p className="mt-3 text-center font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-400">
